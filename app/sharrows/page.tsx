...
export const metadata: Metadata = {
  title: "Sharrows | 海を望む大人の隠れ家",
  description:
    "沖縄・恩納村。エメラルドの海を一望するプライベートヴィラ「Sharrows」。最大6名、寝室3室、プライベートBBQテラス付き。",
};
...
const amenities = [
  ...
  { icon: Tv, label: "50型スマートTV" },
  { icon: Coffee, label: "コーヒーメーカー" },
  { icon: Bath, label: "大型バスタブ" },
];
...
export default function SharrowsPage() {
  return (
    <>
      <Header />
      <main>
                ...
                <AnimatedSection delay={100}>
                  <div className="prose prose-sm max-w-none mb-10">
                    <p className="text-gray-700 leading-relaxed text-base mb-4">
                      エメラルドグリーンに輝く沖縄の海を一望する、贅沢なプライベートヴィラです。
                      広々としたリビングから続くウッドデッキでは、朝は眩しい朝日を、夕暮れ時は
                      水平線に沈む美しいサンセットを楽しめます。
                    </p>
                    <p className="text-gray-700 leading-relaxed text-base mb-4">
                      3つの寝室はそれぞれ独立しており、家族での利用はもちろん、グループ旅行にも最適。
                      大型BBQグリルが設置されたプライベートテラスでは、地元の食材を使った
                      バーベキューをプライベートに楽しめます。
                    </p>
                    <p className="text-gray-700 leading-relaxed text-base">
                      ビーチまで徒歩5分圏内。沖縄の自然を満喫しながら、
                      非日常の時間をお過ごしください。
                    </p>
                  </div>
                </AnimatedSection>
                  ...
                  <div className="border-t border-gray-200 pt-8">
                    ...
                    <div className="space-y-3 text-sm text-gray-600">
                      <div className="flex items-start gap-3">
                        ...
                        />
                        <span>沖縄県国頭郡恩納村（詳細住所はご予約後にお知らせします）</span>
                      </div>
                      <div className="flex items-start gap-3">
                        <Car
                          size={15}
          ...
          <div className="max-w-3xl mx-auto px-6 text-center">
            <AnimatedSection>
              ...
              <p className="text-gray-600 text-sm mb-8">
                記念日・カップルに人気の「Aniversario」もチェック。
              </p>
